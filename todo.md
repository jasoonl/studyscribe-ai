...
- [ ] Inspect the latest Vercel authentication retry logs and fix the remaining Google callback and email/password failures based on their exact non-sensitive categories.
