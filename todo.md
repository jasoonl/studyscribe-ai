...
- [ ] Diagnose and fix migrated-account email/password verification still returning invalid credentials on Vercel, without exposing password hashes or weakening invite-gated signup.
