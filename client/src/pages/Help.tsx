...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "StudyScribe AI supports MP3, WAV, OGG, WebM, and MP4 audio files up to 1GB. Use the 'Upload' tab in the Recorder section or navigate to /upload to drag-and-drop your file.",
  },
  {
    category: "Getting Started",
...
const features = [
  ...
  { icon: Upload, title: "File Upload", desc: "Upload existing audio files (MP3, WAV, OGG, WebM, MP4) up to 1GB.", color: "bg-green-50 text-green-600" },
